	...
	<body>
		<div class="navbar navbar-inverse">
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
				<a href="http://localhost/bootstrap/modul4/tugas/login.php"  class ="dropdown-toggle" data-toggle="dropdown">
					<span class="glyphicon glyphicon-user"></span>
					Armand
					<b class="caret"></b>                                                    
				</a>
				<ul class="dropdown-menu">
					<li><a href="http://localhost/bootstrap/modul4/tugas/login.php">Logout</a></li>
				</ul>
				</li>
			</ul>
		</div><!-- /.navbar-collapse --> 
					...
					<div class="container">
						<div class="row clearfix">
							<div class="col-md-12 column">
								...
								<a href="<?php echo $root; ?>&amp;act=add" class="btn" type="button">Tambah Data</a>
								<a align="pull-right" href="download.php" class="btn" type="button">Download</a>
