	...
	<body>
		<div class="navbar navbar-inverse">
			<ul class="nav navbar-nav">
				<li class="active"><a href="http://localhost/bootstrap/modul4/">Home</a></li>     
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
				<a href="http://localhost/bootstrap/modul4/" class ="dropdown-toggle" data-toggle="dropdown">
					<span class="glyphicon glyphicon-user"></span>
					Armand
					<b class="caret"></b>                                                    
				</a>
				<ul class="dropdown-menu">
					<li><a href="http://localhost/bootstrap/modul4/">Logout</a></li>
				</ul>
				</li>
			</ul>
		</div><!-- /.navbar-collapse --> 
